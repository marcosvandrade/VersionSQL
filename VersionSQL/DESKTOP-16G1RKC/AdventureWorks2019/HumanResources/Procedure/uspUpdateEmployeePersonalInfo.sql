/****** Object:  Procedure [HumanResources].[uspUpdateEmployeePersonalInfo]    Committed by VersionSQL https://www.versionsql.com ******/
...
EXECUTE sys.sp_addextendedproperty @name = N'MS_Description', @value = N'Updates the Employee table with the values specified in the input parameters for the given EmployeeID.', @level0type = N'SCHEMA', @level0name = N'HumanResources', @level1type = N'PROCEDURE', @level1name = N'uspUpdateEmployeePersonalInfo'
